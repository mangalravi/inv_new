...
const sizeChangePercentage = 0.08; // Increase this to make larger adjustments
...
function decreaseFontSize() {
  // Use a larger factor to decrease more quickly
  adjustRootFontSize(1 - sizeChangePercentage * 4); // Adjust the factor for quicker decrease
}
