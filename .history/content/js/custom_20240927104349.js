...
$(function() {
  let lastIndex = 0; // To keep track of the last slide index
  ...
  $("#gallery").on('mouseenter', function() {
    ...
    lastIndex = $(this).slick('slickCurrentSlide');
  }).on('mouseleave', function() {
    // Resume the slider
    $(this).slick('slickPlay');
    
    // Use slickGoTo to start sliding from the last slide index
    $(this).slick('slickGoTo', lastIndex);
  });
});
