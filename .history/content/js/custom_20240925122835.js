...
$(document).ready(function () {
  ...
  function removePrevClasses() {
    ...
    for (let i = prevCount; i > 0; i--) {
      setTimeout(() => {
        items.eq(prevCount - i).removeClass("prev"); // Adjusted to remove in reverse
        removeCount++;
        ...
        if (removeCount === prevCount) {
         ...
         console.log bigimage.trigger('next.owl.carousel');
        }
      }, (prevCount + i + 1) * 400); // Adjusted timing for removal
    }
  }
