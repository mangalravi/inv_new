...
$(function() {
  ...
  $("#gallery").on('mouseenter', function() {
    // Stop the slider immediately by setting autoplaySpeed to a very high value
    $(this).slick('slickSetOption', 'autoplaySpeed', 0, false); // Prevent any sliding
    $(this).slick('slickPause'); // Pause the slider
  }).on('mouseleave', function() {
    // Resume the slider immediately
    $(this).slick('slickSetOption', 'autoplaySpeed', 2000, false); // Reset speed
