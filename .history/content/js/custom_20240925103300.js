...
$(document).ready(function () {
  ...
  function syncPosition(el) {
    ...
    for (let i = 0; i < current; i++) {
      ...
      // Schedule removal of prev class
      (function (index) {
        prevClassTimeouts.push(setTimeout(() => {
          thumbs.find(".owl-item").eq(index).removeClass("prev");
        }, (12 / current) * (i + 1) * 1000));
      })(i);
    }
  ...
  function clearPrevClassTimeouts() {
    prevClassTimeouts.forEach(clearTimeout);
    prevClassTimeouts = [];
  }
