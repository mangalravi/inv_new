...
document.addEventListener("DOMContentLoaded", () => {
  ...
  incbtn.addEventListener("click", () => changeSizeByBtn(2, '.changediv1, .changediv2, .changediv3'));
  decbtn.addEventListener("click", () => changeSizeByBtn(-2, '.changediv1, .changediv2, .changediv3'));
