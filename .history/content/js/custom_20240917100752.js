...
$(document).ready(function () {
  ...
  // Function to update active class on dots
  ...
  // Listen to change events and update the active class
  $owlCarousel.on('changed.owl.carousel', function(event) {
    updateActiveDot();
  });

  // Optionally, listen to `initialized.owl.carousel` to ensure the correct dot is active on first load
