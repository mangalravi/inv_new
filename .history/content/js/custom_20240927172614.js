...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function handleTabSwitch(tabLinksClass, tabContentClass) {
      const tabLinks = document.querySelectorAll(tabLinksClass);
      ...
      tabLinks.forEach(link => {
          ...
          // Add mouseleave event listener to hide the tab content only when the mouse leaves the tab area
          link.addEventListener("mouseleave", function() {
              if (!activeTab.contains(document.querySelector(".tab-link.active"))) {
                  link.classList.remove("active");
                  activeTab.style.display = "none";
              }
          });

          // Event listener for the tab content area
          if (activeTab) {
              activeTab.addEventListener("mouseenter", () => {
                  link.classList.add("active");
                  activeTab.style.display = "block";
              });

              activeTab.addEventListener("mouseleave", () => {
                  link.classList.remove("active");
                  activeTab.style.display = "none";
              });
          }
  ...
  // Call the function with appropriate class selectors
  handleTabSwitch(".tab-link", ".tab");
});
