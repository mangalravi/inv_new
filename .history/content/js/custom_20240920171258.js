...
$(document).ready(function() {
  ...
  var slideDuration = 5000; // Duration for each slide in milliseconds
  var autoplayTimeout; // Variable to store the timeout for autoplay
  ...
  thumbs.on("click", ".owl-item", function(e) {
    e.preventDefault();
    stopAutoplay(); // Stop autoplay immediately on click
    var number = $(this).index();
    bigimage.data("owl.carousel").to(number, 300, true);
    // Restart autoplay after the current slide duration
    setTimeout(startAutoplay, slideDuration);
  });
