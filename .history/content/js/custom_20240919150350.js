...
$(document).ready(function () {
  ...
  $(".testimonialslide").owlCarousel({
   ...
   $(".owl-carousel .owl-item.active.current").on("click", function() {
    pauseButton.style.display = "none";
    playButton.style.display = "flex";
    $(this).addClass("paused"); // Add paused class
});

// Assuming you have .owl-play and .owl-paused buttons to control the carousel
$(".owl-play").on("click", function() {
    $(".owl-carousel .owl-item.active.current").removeClass("paused"); // Remove paused class
});
