...
// document.querySelectorAll('.owl-item.active .list a').forEach(function(link) {
//  console.log(link.parentNode)
//   var iconSpan = document.createElement('span');
//   iconSpan.className = 'icon';
//   iconSpan.innerHTML = link.innerHTML;

//   var circleSpan = document.createElement('span');
//   circleSpan.className = 'circle';

//   // Create the inner spans with <em> elements
//   for (var i = 0; i < 2; i++) {
//       var innerSpan = document.createElement('span');
//       var em = document.createElement('em');
//       innerSpan.appendChild(em);
//       circleSpan.appendChild(innerSpan);
//   }
