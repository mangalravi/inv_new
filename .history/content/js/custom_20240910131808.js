...
const thisli = document.getElementsByClassName("thisli");
...
function applyStoredFontSizes() {
  document
    .querySelectorAll(
      ".sec-head, .main-para, .liItem, .hyperelink, .cardttl, .cardpara ,.mgmenuli"
    )
    .forEach((element) => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  incbtn.addEventListener("click", () =>
    changeSizeByBtn(
      2,
      ".sec-head, .main-para, .liItem, .hyperelink, .cardttl, .cardpara ,.mgmenuli,.thisli"
    )
  );
