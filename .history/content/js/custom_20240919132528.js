...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const bigimage = $("#big");
  const circleAnimation = $(".top-most-banner .owl-item.current .circle");
  ...
  pauseButton.addEventListener("click", function () {
    ...
    circleAnimation.removeClass("running"); // Stop animation
  });
  ...
  playButton.addEventListener("click", function () {
    ...
    circleAnimation.addClass("running"); // Start animation
  });
});
