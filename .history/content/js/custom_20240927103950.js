...
$(function() {
  ...
  $("#gallery").on('mouseenter', function() {
    ...
    const transformValue = $(this).find('.slick-track').css('transform');
    $(this).find('.slick-track').css('transform', transformValue); // Apply current transform
  }).on('mouseleave', function() {
    // Resume the slider
    $(this).slick('slickPlay');
    
    // Remove the transform to allow it to slide again
    $(this).find('.slick-track').css('transform', ''); // Reset to default
  });
});
