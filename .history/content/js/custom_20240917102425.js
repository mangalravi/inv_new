...
$(document).ready(function () {
  ...
  function updateDots(event) {
    ...
    dotContent.forEach(function(content, index) {
      var $button = $(`<button role="button" class="owl-dot" data-index="${index}">
    ...
    $dotsContainer.find(".owl-dot").on('click', function() {
      ...
      owl.trigger('to.owl.carousel', [index, 800]); 
    });
  }
  ...
  function updateActiveDot(event) {
    ...
    // Since `.owl-dots` are recreated in `updateDots`, ensure we have a fresh index to match.
