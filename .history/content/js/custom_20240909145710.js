...
document.addEventListener("DOMContentLoaded", () => {
  ...
  incbtn.addEventListener("click", () => changeSizeByBtn(2, '.sec-head, .main-para, .liItem,.hyperelink,.cardttl,.cardttl'));
  decbtn.addEventListener("click", () => changeSizeByBtn(-2, '.sec-head, .main-para, .liItem,.hyperelink,.cardttl,.cardttl'));
  regbtn.addEventListener("click", () => resetSize('.sec-head, .main-para, .liItem,.hyperelink,.cardttl,.cardttl'));
});
