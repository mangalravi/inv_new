...
$(document).ready(function () {
  $(".loop").owlCarousel({
    ...
    onInitialized: function(event) {
      ...
      var dotContent = [
        { text: 'Next-Gen Utility for Smarter Cities !', imgSrc: 'content/images/banner1-thumbnail.jpg' },
        { text: 'Next-Gen Utility for
Smarter Cities !', imgSrc: 'content/images/banner1-thumbnail.jpg' },
        { text: 'Text 3', imgSrc: 'content/images/banner1-thumbnail.jpg' },
        { text: 'Text 4', imgSrc: 'content/images/banner1-thumbnail.jpg' }
      ];
