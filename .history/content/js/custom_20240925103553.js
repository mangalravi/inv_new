...
$(document).ready(function () {
  ...
  function syncPosition(el) {
    ...
    // Add prev class to all previous items and schedule removal
    for (let i = 0; i < current; i++) {
      const prevItem = thumbs.find(".owl-item").eq(i);
      prevItem.addClass("prev");
  
      // Calculate delay for removal
      const delay = 400 * (current - i); // 400ms for each item
