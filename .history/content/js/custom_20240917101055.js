...
$(document).ready(function () {
  ...
  var $owlCarousel = $carouselContainer.owlCarousel({
    ...
    onInitialized: function(event) {
      // Add custom content to dots
      event.page.pagerLinks.forEach(function(dot, index) {
        var dotHtml = `
  ...
  // Ensure the correct dot is active on first load
  $owlCarousel.on('initialized.owl.carousel', function() {
    var currentIndex = $owlCarousel.find('.owl-dot.active').index();
    $(".owl-dots .owl-dot").removeClass('active');
    $(".owl-dots .owl-dot").eq(currentIndex).addClass('active');
  });
});
