...
const sizeChangePercentage = 0.08; // Amount to change on each click
...
function increaseFontSize() {
  adjustRootFontSize(1 + sizeChangePercentage);
}

// Function to decrease font size
function decreaseFontSize() {
  const currentFontSize = getRootFontSize();
  const decreaseAmount = (currentFontSize - minFontSize) / 2; // Calculate the amount to decrease for 2 clicks
  adjustRootFontSize((currentFontSize - decreaseAmount) / currentFontSize); // Calculate the new factor
}
