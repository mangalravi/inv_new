...
$(document).ready(function() {
  ...
  var autoplaySpeed = 3000; // Adjust this value if needed
  ...
  playButton.addEventListener("click", function () {
    // Get the current index and calculate the remaining time
    var currentIndex = bigimage.find('.owl-item.active').index();
    var timeElapsed = bigimage.data('owl.carousel').currentSlide * autoplaySpeed;
console.log("timeElapsed =>",bigimage.data('owl.carousel').currentSlide);
