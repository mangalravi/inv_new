...
$(document).ready(function() {
  ...
  // Custom function to manage aria-hidden
  function manageAriaHidden() {
  ...
  // Trigger function on initialization and after change
  bigimage.on('init afterChange', manageAriaHidden);
  thumbs.on('init afterChange', manageAriaHidden);
