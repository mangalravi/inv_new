...
document.addEventListener("DOMContentLoaded", () => {
  ...
  incbtn.addEventListener("click", () => changeSizeByBtn(2, '.sec-head, .main-para, .liItem,.hyperelink'));
  decbtn.addEventListener("click", () => changeSizeByBtn(-2, '.sec-head, .main-para, .liItem,.hyperelink'));
  regbtn.addEventListener("click", () => resetSize('.sec-head, .main-para, .liItem,.hyperelink'));
});
