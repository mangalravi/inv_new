...
$(function () {
  $("#gallery").slick({
    ...
    responsive: [
        {
            breakpoint: 1900, // For screens less than 1900px
            settings: {
                slidesToShow: 5,
            }
        },
        {
            breakpoint: 1200, // For screens less than 1600px
            settings: {
                slidesToShow: 6,
            }
        },
        {
            breakpoint: 992, // For screens less than 1200px
            settings: {
                slidesToShow: 5,
            }
        },
        {
            breakpoint: 768, // For screens less than 800px
            settings: {
                slidesToShow: 4,
            }
        },
        {
            breakpoint: 525, // For screens less than 480px
            settings: {
                slidesToShow: 3,
            }
        },
        {
          breakpoint: 375, // For screens less than 480px
          settings: {
              slidesToShow: 2,
          }
      }
