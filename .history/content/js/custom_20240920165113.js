...
$(document).ready(function() {
  ...
  function startAutoplay() {
    autoplayTimeout = setTimeout(function() {
      ...
      remainingTime = autoplayTime; // Reset remaining time
      startAutoplay();
    }, remainingTime);
  }
  ...
  // Pause function to calculate remaining time
  function pauseCarousel() {
    stopAutoplay();
    var currentSlideIndex = bigimage.find('.owl-item.active').index();
    remainingTime -= (new Date().getTime() - startTime) % autoplayTime; // Calculate remaining time
  }
