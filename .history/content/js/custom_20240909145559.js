...
document.addEventListener("DOMContentLoaded", () => {
  ...
  incbtn.addEventListener("click", () => changeSizeByBtn(2, '.sec-head, .main-para, .liItem,.'));
  decbtn.addEventListener("click", () => changeSizeByBtn(-2, '.sec-head, .main-para, .liItem,.'));
  regbtn.addEventListener("click", () => resetSize('.sec-head, .main-para, .liItem,.'));
});
