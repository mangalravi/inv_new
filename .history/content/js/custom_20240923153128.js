...
$(document).ready(function () {
  $(".client-slide").owlCarousel({
    ...
    margin: 30,
    autoplay: true,
    autoplayTimeout: 2000, // Adjusted for a longer display time
    autoplayHoverPause: true,
    nav: false,
    smartSpeed: 800, // Smooth transition speed
    animateOut: 'fadeOut', // Optional: Add fade out animation
    animateIn: 'fadeIn', // Optional: Add fade in animation
    responsive: {
      0: {
        items: 1,
      },
