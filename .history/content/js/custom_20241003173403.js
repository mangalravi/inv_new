...
$(document).ready(function(){
  $("#gallery").slick({
    ...
    responsive: [
        {
            breakpoint: 1440, // For screens less than 1440px
            settings: {
                slidesToShow: 5,
                slidesToScroll: 1 // Add this if you want to scroll one slide at a time
            }
        },
        {
        ...
        {
            breakpoint: 992, // For screens less than 992px
            settings: {
                slidesToShow: 3,
                slidesToScroll: 1
            }
