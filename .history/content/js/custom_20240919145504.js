...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const bigimage = $("#big"); 
  const circleElements = document.querySelectorAll(".top-most-banner .owl-item.current .circle::before");
  ...
  pauseButton.addEventListener("click", function () {
    ...
    // Add a class to pause animation
  ...
  playButton.addEventListener("click", function () {
    ...
    // Remove the class to resume animation
    circleElements.forEach(circle => {
