...
document.addEventListener("DOMContentLoaded", function () {
  ...
  pauseButton.style.display = "none"; // Initially hide pause button
  ...
  playButton.addEventListener("click", function () {
    bigimage.trigger("play.owl.autoplay", [5000]);
    bigimage.trigger("to.owl.carousel", [currentIndex, 0]); // Resume from the current index
...
$(document).ready(function () {
  ...
  bigimage
    .owlCarousel({
      ...
      nav: true,
      autoplay: true,
      autoplayTimeout: 5000, // Set to 5 seconds
      dots: false,
      loop: true,
  ...
  thumbs.on("click", ".owl-item", function (e) {
    ...
    // Stop current autoplay and set a timeout to play the next slide after 5 seconds
    bigimage.trigger("stop.owl.autoplay");
    bigimage.data("owl.carousel").to(number, 300, true);

    // Restart autoplay after a 5 second delay
