...
function handleResponsiveStyles() {
  ...
  if (viewportWidth < 575) {
    loadCSS("content/css/Responsive-ExtraSmall.css"); // For widths < 575px
  } else if (viewportWidth >= 576 && viewportWidth < 767) {
    loadCSS("content/css/Responsive-Mobile.css"); // For widths between 576px and 767px
  } else if (viewportWidth >= 768 && viewportWidth < 991) {
    loadCSS("content/css/Responsive-Medium.css"); // For widths between 768px and 991px
  } else if (viewportWidth >= 576 && viewportWidth < 991) {
    loadCSS("content/css/Responsive-Leptop.css"); // For widths between 576px and 991px
  } else if (viewportWidth >= 992) {
    loadCSS("content/css/Responsive-Desktop.css"); // For widths > 992px
  }
}
