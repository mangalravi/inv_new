...
$(function() {
  let lastTransform = 'translate3d(0, 0, 0)'; // To store the last transform value
  ...
  $("#gallery").on('mouseenter', function() {
    ...
    // Apply the same transform value to resume smoothly
    $(this).find('.slick-track').css('transform', lastTransform); // Maintain the last position
  });
});
