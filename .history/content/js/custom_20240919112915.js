...
$(document).ready(function () {
  ...
  bigimage.owlCarousel({
    ...
    // Update current class for thumbnails
    thumbs.find(".owl-item").removeClass("current");
    var thumbIndex = currentIndex % thumbs.find(".owl-item").length; // Calculate thumb index
  ...
  thumbs.on("initialized.owl.carousel", function () {
    ...
    // Sync bigimage carousel with thumbs
    var number = event.item.index;
    bigimage.data("owl.carousel").to(number, 100, true);

    // Update current class for clicked thumbnail
    thumbs.find(".owl-item").removeClass("current");
