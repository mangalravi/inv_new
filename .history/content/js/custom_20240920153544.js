...
document.addEventListener("DOMContentLoaded", function () {
  ...
  pauseButton.addEventListener("click", function () {
    ...
    currentIndex = bigimage.find('.owl-item.active').index(); // Get the current index
    pauseButton.style.display = "none";
    playButton.style.display = "flex";
  });

  playButton.addEventListener("click", function () {
    bigimage.trigger('play.owl.autoplay', [3000]); // Resume autoplay with a delay
    bigimage.trigger('to.owl.carousel', [currentIndex]); // Go to the last active index
    playButton.style.display = "none";
