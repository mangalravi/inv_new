...
//     // Close all submenus and remove active class from all parent menus
//     const allSubmenus = document.querySelectorAll('.submenu');
//     const parentMenus = document.querySelectorAll('.parent-menu');
...
//     // Open the clicked submenu and add active class if it was closed
//     if (!isActive) {
//       submenu.style.display = 'block';
...
// $(document).ready(function() {
//   // Prevent the first offcanvas from closing on link click
//   $('#First .parent-menu a').on('click', function(event) {
//     event.stopPropagation(); // Prevents the click event from bubbling up
//   });

//   // Show the second offcanvas and hide the first
//   $('.parent-menu.hvrmnu.parentmenu1').on('click', function() {
//     // $('#First').offcanvas('hide'); 
//     $('#Second').offcanvas('show'); // Show the second offcanvas
//   });

//   // When the second offcanvas is hidden, show the first offcanvas
//   $('#Second').on('hidden.bs.offcanvas', function () {
...
$(document).ready(function() {
  ...
  // Open the second offcanvas and add offtrans class to the first
  $('.parent-menu.hvrmnu.parentmenu1').on('click', function() {
    $('#First').addClass('offtrans'); // Add the offtrans class
    $('#Second').offcanvas('show'); // Show the second offcanvas
  });

  // Close the first offcanvas and remove offtrans class
  $('#First .btn-close').on('click', function() {
    $('#First').removeClass('offtrans'); // Remove the offtrans class
  });

  // When the second offcanvas is hidden, you can handle any additional logic here
  $('#Second').on('hidden.bs.offcanvas', function () {
    // If you want to show the first offcanvas again, uncomment the line below
