  ...
  function storeDefaultCSSVariables() {
    const variables = [
      '--font-size-sec-head',
      '--font-size-main-para',
      '--font-size-liItem',
      '--font-size-hyperelink',
      '--font-size-cardttl',
      '--font-size-cardpara'
    ];
    ...
    variables.forEach(variable => {
      ...
      localStorage.setItem(`default-${variable}`, value);
    });
  }
  
  function applyStoredCSSVariables() {
    const variables = [
      '--font-size-sec-head',
      '--font-size-main-para',
      '--font-size-liItem',
    ...
    variables.forEach(variable => {
      let storedValue = localStorage.getItem(`default-${variable}`);
      if (storedValue) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    storeDefaultCSSVariables(); // Store default values on load
    applyStoredCSSVariables(); // Apply stored values on load
