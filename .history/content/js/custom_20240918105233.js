...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Check if the animated element exists
...
console.log(a);
      ...
      pauseButton.addEventListener('click', function() {
          ...
          animatedElement.style.animationPlayState = 'paused'; // Pause animation
      });

      playButton.addEventListener('click', function() {
          playButton.style.display = 'none';
          pauseButton.style.display = 'block';
          animatedElement.style.animationPlayState = 'running'; // Resume animation
      });
  } else {
      console.error('Animated element not found. Please check your HTML structure.');
  }
});
