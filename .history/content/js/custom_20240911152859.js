...
document.addEventListener("DOMContentLoaded", () => {
  // Get the toggle image and menu elements
  ...
  // Function to hide the menu if clicked outside
  ...
  // Add event listeners for click on toggle image
  if (toggleImage) {
  ...
  // Prevent the menu from hiding when hovering over it
  if (menu) {
  ...
  // Optionally, add hover behavior (uncomment if needed)
  // toggleImage.addEventListener("mouseover", toggleMenu);
