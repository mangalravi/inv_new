...
$(function() {
  $("#gallery").slick({
    ...
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 0, // Keep this as 0 for continuous scrolling
    speed: 2000,
    infinite: true,
    arrows: false,
    cssEase: 'linear',
  ...
  // Stop sliding immediately on hover
  $("#gallery").on('mouseenter', function() {
    $(this).slick('slickSetOption', 'autoplay', false, true); // Stop autoplay immediately
  }).on('mouseleave', function() {
    $(this).slick('slickSetOption', 'autoplay', true, true); // Resume autoplay immediately
  });
});
