...
incbtn.click(changeSizeByBtn(2, '.changediv1, .changediv2, .changediv3'))
regbtn.click(changeSizeByBtn(2, '.changediv1, .changediv2, .changediv3'))
decbtn.click(changeSizeByBtn(-2, '.changediv1, .changediv2, .changediv3'))
