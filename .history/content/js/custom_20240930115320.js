...
$(function() {
  ...
  // Pause the slider immediately on hover
  $("#gallery").on('mouseenter', function() {
    $(this).slick('slickPause'); // Immediately stop sliding
  }).on('mouseleave', function() {
    $(this).slick('slickPlay');  // Resume sliding immediately
  });

  // Set a custom continuous scroll using a setInterval
  setInterval(function() {
    $("#gallery").slick('slickNext'); // Move to the next slide
  }, 2000); // Match this interval to your desired autoplay speed
});
