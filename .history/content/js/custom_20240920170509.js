...
$(document).ready(function() {
  ...
  var slideDuration = 3000; // duration for each slide
  ...
  bigimage.owlCarousel({
    ...
    // Reset the remaining time for the next slide
  ...
  // Optional: Add a play button to start autoplay
  $("#playButton").on("click", function() {
    stopAutoplay(); // Stop current autoplay
    remainingTime = slideDuration; // Reset remaining time
