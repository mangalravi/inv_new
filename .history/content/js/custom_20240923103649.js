...
$(document).ready(function() {
  const playButton = $(".owl-play");
  const pauseButton = $(".owl-pause");
  const bigimage = $("#big");
  const thumbs = $("#thumbs");
  let autoplaySpeed = 3000; // Set your desired speed here
  ...
  playButton.on("click", function() {
    bigimage.trigger('play.owl.autoplay', [autoplaySpeed]);
    playButton.hide();
    pauseButton.show();
  });
  ...
  // Initialize the active class on the first item
