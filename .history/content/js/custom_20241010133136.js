...
//     // Optionally, show the Main tab by default
...
$(document).ready(function() {
  // Prevent the Main offcanvas from closing on link click
  $('#Main .parent-menu a').on('click', function(event) {
    event.stopPropagation(); // Prevents the click event from bubbling up
  });

  // Show the second offcanvas and hide the Main
  $('.parent-menu.hvrmnu.parentmenu1').on('click', function() {
    // $('#Main').offcanvas('hide'); 
    $('#Second').offcanvas('show'); // Show the second offcanvas
  });

  // When the second offcanvas is hidden, show the Main offcanvas
  $('#Second').on('hidden.bs.offcanvas', function () {
    $('#Main').offcanvas('show'); // Show the Main offcanvas again
  });
});
...
$(document).ready(function() {
  $('.menu').click(function() {
      $('#Main').addClass('offtrans');
  });

  $('#Main .btn-close').click(function() {
      $('#Main').removeClass('offtrans');
  });
});