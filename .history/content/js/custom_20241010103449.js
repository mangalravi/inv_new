...
// Assuming you're using Bootstrap's offcanvas
$(document).ready(function() {
  // When the second offcanvas is hidden
  $('#Second').on('hidden.bs.offcanvas', function () {
    $('#First').offcanvas('show'); // Show the first offcanvas
  });

  // Optionally, ensure the first offcanvas can be opened from the second
  $('.parent-menu.hvrmnu').on('click', function () {
    $('#First').offcanvas('hide'); // Hide the first when opening the second
  });
});
