...
$( ".anitxt" ).mouseenter(function(e) {
  var parentOffset = $(this).offset(); 
 
  var relX = e.pageX - parentOffset.left;
  var relY = e.pageY - parentOffset.top;
  $(this).prev(".anicircle").css({"left": relX, "top": relY });
  $(this).prev(".anicircle").removeClass("desplode-circle");
  $(this).prev(".anicircle").addClass("explode-circle");

});

$( ".anitxt" ).mouseleave(function(e) {
    ...
    var relY = e.pageY - parentOffset.top;
    $(this).prev(".anicircle").css({"left": relX, "top": relY });
    $(this).prev(".anicircle").removeClass("explode-circle");
    $(this).prev(".anicircle").addClass("desplode-circle");

}); 
$(".anibtn").mouseenter(function() {
  $(this).siblings(".anitxt").css("color", "red");
}).mouseleave(function() {
  $(this).siblings(".anitxt").css("color", ""); // Reset to original color
});
