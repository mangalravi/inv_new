  ...
  $(".loop").owlCarousel({
    ...
    onInitialized: function(event) {
      ...
      $dots.each(function(index) {
        ...
        // Example: Add text inside the dot
        $dot.html('<span>Text ' + (index + 1) + '</span>');

        // Alternatively, add an image inside the dot
        // $dot.html('<img src="path/to/image' + (index + 1) + '.jpg" alt="Image ' + (index + 1) + '">');
      });
    }
  });
});
