...
function getResponsiveFontSize() {
  ...
  if (viewportWidth < 768) return 16; // Example for mobile
  if (viewportWidth >= 768 && viewportWidth <= 991) return 18; // Example for tablet
  return 20; // Example for desktop
}
...
function getElementStorageKey(element) {
  return element.className.split(" ").find(cls => cls);
}
