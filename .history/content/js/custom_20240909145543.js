...
document.addEventListener("DOMContentLoaded", () => {
  ...
  incbtn.addEventListener("click", () => changeSizeByBtn(2, '.sec-head, .main-para, .changediv3'));
  decbtn.addEventListener("click", () => changeSizeByBtn(-2, '.sec-head, .main-para, .changediv3'));
  regbtn.addEventListener("click", () => resetSize('.sec-head, .main-para, .changediv3'));
});
