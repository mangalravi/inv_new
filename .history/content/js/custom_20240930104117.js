...
$(function() {
  ...
  $("#gallery").on('mouseenter', function() {
    $(this).slick('slickPause'); // Pause the slider immediately
  }).on('mouseleave', function() {
    $(this).slick('slickPlay'); // Resume the slider immediately
  });

  // Make it a continuous scroll
  setInterval(function() {
    $("#gallery").slick('slickNext'); // Move to the next slide
  }, 2000); // Set the interval to match autoplaySpeed
});
