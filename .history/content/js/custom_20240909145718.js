...
document.addEventListener("DOMContentLoaded", () => {
  ...
  incbtn.addEventListener("click", () => changeSizeByBtn(2, '.sec-head, .main-para, .liItem,.hyperelink,.cardttl,.cardpara'));
  decbtn.addEventListener("click", () => changeSizeByBtn(-2, '.sec-head, .main-para, .liItem,.hyperelink,.cardttl,.cardpara'));
  regbtn.addEventListener("click", () => resetSize('.sec-head, .main-para, .liItem,.hyperelink,.cardttl,.cardpara'));
});
